...
export function ResumePreview({
  ...
  const renderSummarySection = () => {
    ...
    return (
      <div className="mb-6">
        <h2
          className={`font-bold text-orange-600 mb-3 border-b border-orange-200 pb-1 ${getSectionHeaderSize(template)}`}
        >
  ...
  if (
    ...
    return (
      <div className="text-center py-12 text-gray-400">
        ...
        <p>
          Start filling out the form on the left to see your resume come to
          life!
        </p>
  ...
  return (
    <div
      className={`max-w-none text-sm leading-relaxed ${getTemplateStyles(template)}`}
    >
      <DndContext
        sensors={sensors}
